...
class Interface:
    ...
    def set_treeview(self):
        ...
        self.frame1 = tk.LabelFrame(self.consulta_frame, text="SQL Data")
    ...
    def set_search(self):
        ...
        self.busqueda_frame = tk.LabelFrame(self.consulta_frame, text="Selection criteria")
        self.busqueda_frame.place(height=120, width=780, rely=0.47, relx=0.014)  # Dejar así fijado el ancho y las rel x e y.

        # Nom
        self.nom_label = tk.Label(self.busqueda_frame, text="Name")
        ...
        # Cognom1
        self.cognom1_label = tk.Label(self.busqueda_frame, text="1s surname")
        ...
        # Cognom2
        self.cognom2_label = tk.Label(self.busqueda_frame, text="2d surname")
        ...
        #  Materia
        self.materia_label = tk.Label(self.busqueda_frame, text="Subject")
        ...
        self.materia_combobox['values'] = Interface.materies
        ...
        # consideraciones
        self.consideraciones_label1 = tk.Label(self.busqueda_frame, text="Consideration")
        ...
        self.consideraciones_busqueda['values'] = self.considerations

        # Estat
        self.estat_label1 = tk.Label(self.busqueda_frame, text="Current state")
        ...
        self.estat_combobox['values'] = Interface.estados_matricula
        ...
        self.fecha_label1 = tk.Label(self.busqueda_frame, text="Registration date")
        ...
        self.ciclefp_label1 = tk.Label(self.busqueda_frame, text="Course")
        ...
        self.busqueda_button = tk.Button(self.busqueda_frame, text="Search", command=self.SQL_Query) # setconfig externos?
        self.busqueda_button.place(relx=0.85, rely=0.55, width=100)

        ####### Botón para exportar el resultado #######
        self.exportar_button = tk.Button(self.consulta_frame, text="Export data", command=self.Exportar_Excel)  # Nota: Exportar con un índice autogenerado.
        self.exportar_button.place(relx=0.845, rely=0.78, width=100)
    ...
    def set_agregar(self):
        ...
        # Frame para todas las Entry y el botón de búsqueda
        self.agregar_frame = tk.LabelFrame(self.frame_agregar, text="Criteria")
        self.agregar_frame.place(height=400, width=780, rely=0.05, relx=0.014)  # Dejar así fijado el ancho y las rel x e y.

        # Nom
        self.nom_label2 = tk.Label(self.agregar_frame, text="Name")
        ...
        # Cognom1
        self.cognom1_label2 = tk.Label(self.agregar_frame, text="1s surname")
        ...
        # Cognom2
        self.cognom2_label2 = tk.Label(self.agregar_frame, text="2d surname")
        ...
        # Materia
        self.materia_label2 = tk.Label(self.agregar_frame, text="Subject")
        ...
        self.materia_combobox2['values'] = Interface.materies
        ...
        # Adaptacions
        self.adaptacion_label = tk.Label(self.agregar_frame, text="Adaptation")
        ...
        self.consideracions_label = tk.Label(self.agregar_frame, text="Consideration")
        ...
        self.consideracion_lista['values'] = Interface.considerations

        # Estat
        self.estat_label2 = tk.Label(self.agregar_frame, text="Current state")
        ...
        # Documents
        self.documents_label = tk.Label(self.agregar_frame, text="Documentation")
        ...
        # Fecha
        self.fecha_label2 = tk.Label(self.agregar_frame, text="Registration date")
        ...
        self.ciclefp_label2 = tk.Label(self.agregar_frame, text="Course")
        ...
        self.afegir_button = tk.Button(self.agregar_frame, text="Add student", command=self.Agregar_Alumno)
        self.afegir_button.place(relx=0.8, rely=0.04)

    def set_adaptaciones(self):

        self.adaptacions_labelframe = tk.LabelFrame(self.adaptaciones_frame, text="Introduce username to update adaptations")
        ...
        self.agregar_adaptacion = tk.Button(self.adaptaciones_frame, text="Add adaptation", command=self.Agregar_Adaptacion)
        self.agregar_adaptacion.place(relx=0.6, rely=0.22, width=150)

    def set_documentos(self):

        self.documentos_labelframe = tk.LabelFrame(self.documentos_frame, text="Introduce username to update documents")
        ...
        # Botón de modificación
        self.agregar_documentos = tk.Button(self.documentos_frame, text="Afegir documentació", command=self.Agregar_Documentos)
    ...
    def set_upload(self):
        ...
        self.cargar_button = tk.Button(self.upload_labelframe, text="Open file", command=self.Cargar_CSV)
        self.cargar_button.place(relx=0.05, rely=0.05)
        self.ruta_label = tk.Label(self.upload_labelframe, text="Loaded file: None")
        self.ruta_label.place(relx=0.20, rely=0.07)
        self.actualizar_button = tk.Button(self.upload_labelframe, text="Update Batx Database", command=self.Actualizar_BBDD_Batx)
        self.actualizar_button.place(relx=0.05, rely=0.35)
        self.actualizarFP_button = tk.Button(self.upload_labelframe, text="Update FP Database", command=self.Actualizar_BBDD_FP)
        self.actualizarFP_button.place(relx=0.05, rely=0.45)
        self.actualizarFP_button = tk.Button(self.upload_labelframe, text="Update GES Database", command=self.Actualizar_BBDD_GES)
        self.actualizarFP_button.place(relx=0.05, rely=0.55)
        self.fecha_actualizacion_label = tk.Label(self.upload_labelframe, text="Registration date DD/MM/AAAA")
    ...
    def set_consideraciones(self):
        ...
        self.consideraciones_labelframe = tk.LabelFrame(self.consideraciones_frame, text="Code list")
